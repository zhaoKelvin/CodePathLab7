...
class GoTrueClient {
    ...
    signInWithOAuth(credentials) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this._handleProviderSignIn(credentials.provider, {
                ...
                flowType: (_f = (_e = credentials.options) === null || _e === void 0 ? void 0 : _e.flowType) !== null && _f !== void 0 ? _f : 'implicit',
            });
        });
    }
    /**
    ...
    exchangeCodeForSession(authCode) {
        return __awaiter(this, void 0, void 0, function* () {
            const codeVerifier = yield (0, helpers_1.getItemAsync)(this.storage, `${this.storageKey}-oauth-code-verifier`);
            ...
            yield (0, helpers_1.removeItemAsync)(this.storage, `${this.storageKey}-oauth-code-verifier`);
            if (error || !data)
                return { data: { user: null, session: null }, error };
            if (data.session) {
                yield this._saveSession(data.session);
    ...
    _getUrlForProvider(provider, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((options === null || options === void 0 ? void 0 : options.flowType) === 'pkce') {
                ...
                yield (0, helpers_1.setItemAsync)(this.storage, `${this.storageKey}-oauth-code-verifier`, codeVerifier);
